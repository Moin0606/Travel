...
import { User, Mail, Lock, CheckCircle, Phone, MapPin, File, Image, Calendar, UserCircle } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const { username, email, password, profilePicture, age, gender, address, phoneNumber, verificationDocument } = formData;

    if (!username || !email || !password || !confirmPassword || !profilePicture || !age || !gender || !address || !phoneNumber || !verificationDocument) {
